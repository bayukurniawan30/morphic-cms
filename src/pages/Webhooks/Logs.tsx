            ...
            <Tabs defaultValue="request" className="w-full">
              ...
              <TabsContent value="request" className="space-y-4">
                <div className="space-y-2">
                  ...
                  <pre className="bg-muted/80 p-3 rounded-lg border text-[11px] font-mono overflow-x-auto max-h-[150px] custom-scrollbar text-foreground">
                ...
                <div className="space-y-2">
                  ...
                  <pre className="bg-muted/80 p-3 rounded-lg border text-[11px] font-mono overflow-x-auto max-h-[300px] custom-scrollbar text-foreground">
