      ...
      <div className="flex flex-col space-y-6">
        <div className="flex flex-col sm:flex-row justify-between space-y-4 sm:space-y-0">
          <div>
            ...
            <p className="text-muted-foreground text-sm">Define forms and manage third-party API entries ({forms?.length || 0} total).</p>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left">
              <thead className="text-xs text-muted-foreground uppercase bg-muted/50 border-b">
                <tr>
                  <th className="px-6 py-4 font-medium uppercase tracking-wider">Form Name</th>
                  <th className="px-6 py-4 font-medium uppercase tracking-wider">Slug</th>
                  <th className="px-6 py-4 font-medium uppercase tracking-wider">Storage</th>
                  <th className="px-6 py-4 font-medium uppercase tracking-wider">Target API URL</th>
                ...
                {forms?.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-muted-foreground">
                      ...
                      <p className="text-sm opacity-70 mt-1">Ready to bridge your third-party API? Create your first form.</p>
