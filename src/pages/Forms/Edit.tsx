      ...
      <div className='w-full space-y-8'>
        <div className='flex items-center space-x-4'>
          ...
          <div>
            ...
            <p className='text-muted-foreground mt-1'>{form.name} definition</p>
          </div>
        </div>
            ...
            <div className='bg-card p-6 rounded-xl border shadow-sm space-y-4 border-l-4 border-l-primary/30'>
              ...
              <div className='space-y-2'>
                ...
                <p className='text-[10px] text-muted-foreground'>
                  Linking to a collection allows the CMS to show these
                  submissions alongside your entries.
                </p>
              </div>
                ...
                <div className='space-y-3 pt-2'>
                  ...
                  <div className='space-y-2'>
                    {Object.entries(data.apiHeaders).map(([k, v]) => (
                      <div
                        key={k}
                        className='flex gap-2 items-center bg-background p-2 rounded-md group border border-muted/50'
                      >
