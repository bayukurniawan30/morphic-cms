        ...
        >
          <div className='px-6 border-b flex-shrink-0'>
            <TabsList className='bg-transparent border-b-0 w-full justify-start space-x-6 h-12 p-0'>
              <TabsTrigger
                value='library'
                className='data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none h-full px-0 !shadow-none'
              >
                Library
              </TabsTrigger>
              <TabsTrigger
          ...
          <TabsContent
            value='library'
            className='flex-1 min-h-0 h-full p-0 m-0 overflow-hidden data-[state=active]:flex data-[state=active]:flex-col'
          >
            ...
            <ScrollArea className='flex-1 min-h-0 h-full p-6'>
              {loading ? (
                <LoadingState
                  ...
                  className='h-48 border-none bg-transparent'
                />
          ...
          <TabsContent
            value='upload'
            className='flex-1 min-h-0 h-full items-center justify-center p-12 m-0 bg-muted/10 data-[state=active]:flex data-[state=active]:flex-col relative'
          >
            <div
