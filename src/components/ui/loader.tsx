...
export function LoadingState({ text = "Loading media...", className }: { text?: string; className?: string }) {
  return (
    <div className={cn("h-64 flex items-center justify-center bg-card/30 border border-dashed rounded-lg", className)}>
